...
import { fleetNavigationSections } from '@/lib/fleet-navigation-config';
...
export default function FleetHeaderNav() {
  const pathname = usePathname();

  // Check if any item in a section is active
  const isSectionActive = (section: typeof fleetNavigationSections[0]) => {
            ...
            {fleetNavigationSections.map((section) => {
              ...
              return (
                <div key={section.title}>
                  ...
                  {section !== fleetNavigationSections[fleetNavigationSections.length - 1] && (
                    <DropdownMenuSeparator />
                  )}
                </div>
              );
