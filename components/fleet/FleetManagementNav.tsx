...
const navItems: NavItem[] = [
  ...
  { name: 'Breakdowns', href: '/dashboard/breakdowns', icon: AlertTriangle },
  { name: 'Inspections', href: '/dashboard/inspections', icon: ClipboardCheck },
  { name: 'Fleet Board', href: '/dashboard/fleet-board', icon: BarChart3 },
  { name: 'Inventory', href: '/dashboard/inventory', icon: Warehouse },
];

export default function FleetManagementNav() {
