...
const pricingPlans = [
  {
    ...
    features: ['Up to 10 trucks', 'Load management', 'Driver profiles', 'Basic invoicing', 'Email support'],
    popular: false,
  ...
  },
  {
    ...
    features: ['Up to 50 trucks', 'Everything in Starter', 'GPS tracking', 'Settlements', 'Safety compliance', 'Priority support'],
    popular: true,
    cta: 'Start Free Trial',
  },
  {
    ...
    features: ['Unlimited trucks', 'Everything in Pro', 'Dedicated support', 'Custom integrations', 'API access', 'SLA guarantee'],
    popular: false,
    cta: 'Contact Sales',
  },
];
