...
export const ENTITY_FIELDS: Record<string, { key: string; label: string; required: boolean; aliases: string[] }[]> = {
    drivers: [
        { key: 'firstName', label: 'First Name', required: false, aliases: ['first name', 'firstname', 'first', 'fname', 'given name'] },
        { key: 'lastName', label: 'Last Name', required: false, aliases: ['last name', 'lastname', 'last', 'lname', 'surname', 'family name'] },
    ...
    trucks: [
        { key: 'truckNumber', label: 'Truck/Unit Number', required: false, aliases: ['truck number', 'unit number', 'truck', 'unit', 'truck #', 'unit #', 'vehicle number'] },
        ...
        { key: 'year', label: 'Year', required: false, aliases: ['year', 'mfg year'] },
        { key: 'licensePlate', label: 'License Plate', required: false, aliases: ['license plate', 'plate', 'tag'] },
        { key: 'state', label: 'State', required: false, aliases: ['state', 'registration state', 'plate state'] },
        { key: 'equipmentType', label: 'Equipment Type', required: false, aliases: ['equipment type', 'type', 'truck type'] },
        { key: 'registrationExpiry', label: 'Registration Expiry', required: false, aliases: ['registration expiry', 'reg exp'] },
        { key: 'insuranceExpiry', label: 'Insurance Expiry', required: false, aliases: ['insurance expiry', 'ins exp'] },
        { key: 'inspectionExpiry', label: 'Inspection Expiry', required: false, aliases: ['inspection expiry', 'insp exp'] },
        { key: 'odometerReading', label: 'Odometer', required: false, aliases: ['odometer', 'mileage'] },
        { key: 'capacity', label: 'Capacity', required: false, aliases: ['capacity', 'max weight'] },
        { key: 'status', label: 'Status', required: false, aliases: ['status', 'condition'] },
    ],
    trailers: [
        { key: 'trailerNumber', label: 'Trailer/Unit Number', required: false, aliases: ['trailer number', 'unit number', 'trailer', 'unit', 'trailer #'] },
        ...
        { key: 'licensePlate', label: 'License Plate', required: false, aliases: ['license plate', 'plate', 'tag'] },
        { key: 'state', label: 'State', required: false, aliases: ['state', 'registration state'] },
        { key: 'registrationExpiry', label: 'Registration Expiry', required: false, aliases: ['registration expiry', 'reg exp'] },
        { key: 'insuranceExpiry', label: 'Insurance Expiry', required: false, aliases: ['insurance expiry', 'ins exp'] },
        { key: 'inspectionExpiry', label: 'Inspection Expiry', required: false, aliases: ['inspection expiry', 'insp exp'] },
        { key: 'status', label: 'Status', required: false, aliases: ['status', 'condition'] },
    ...
    customers: [
        { key: 'name', label: 'Company Name', required: false, aliases: ['name', 'company name', 'customer name', 'customer', 'company'] },
    ...
    loads: [
        { key: 'loadNumber', label: 'Load Number', required: false, aliases: ['load number', 'load #', 'load', 'order number', 'id'] },
        { key: 'revenue', label: 'Revenue/Rate', required: false, aliases: ['rate', 'amount', 'price', 'revenue', 'load pay', 'pay'] },
        { key: 'totalMiles', label: 'Total Miles', required: false, aliases: ['miles', 'total miles', 'distance'] },
        { key: 'pickupCity', label: 'Pickup City', required: false, aliases: ['origin city', 'pickup city', 'from city', 'origin'] },
        { key: 'pickupState', label: 'Pickup State', required: false, aliases: ['origin state', 'pickup state', 'from state', 'st'] },
        { key: 'deliveryCity', label: 'Delivery City', required: false, aliases: ['destination city', 'dest city', 'delivery city', 'to city', 'destination'] },
        { key: 'deliveryState', label: 'Delivery State', required: false, aliases: ['destination state', 'dest state', 'delivery state', 'to state', 'dst st'] },
        { key: 'pickupDate', label: 'Pickup Date', required: false, aliases: ['pickup date', 'pick up date', 'load date', 'pu date'] },
        { key: 'deliveryDate', label: 'Delivery Date', required: false, aliases: ['delivery date', 'drop date', 'deliver date', 'del date'] },
        { key: 'weight', label: 'Weight', required: false, aliases: ['weight', 'lbs', 'gross weight'] },
        { key: 'driverPay', label: 'Driver Pay', required: false, aliases: ['driver pay', 'pay rate', 'driver total'] },
        { key: 'status', label: 'Status', required: false, aliases: ['status', 'load status'] },
    ],
};
