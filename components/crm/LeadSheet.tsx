...
const defaultValues: LeadFormValues = {
    ...
    cdlNumber: '', cdlClass: '', cdlExpiration: '',
    endorsements: [], yearsExperience: undefined,
    freightTypes: [], previousEmployers: '',
            ...
            .then((data) => {
                if (data.lead) {
                    ...
                    form.reset({
                        ...
                        dateOfBirth: data.lead.dateOfBirth ? new Date(data.lead.dateOfBirth).toISOString().split('T')[0] : '',
                        ...
                        cdlExpiration: data.lead.cdlExpiration ? new Date(data.lead.cdlExpiration).toISOString().split('T')[0] : '',
                        endorsements: data.lead.endorsements || [],
                        yearsExperience: data.lead.yearsExperience || undefined,
                        freightTypes: data.lead.freightTypes || [],
                        previousEmployers: data.lead.previousEmployers || '',
