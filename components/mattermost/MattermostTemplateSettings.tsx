...
export default function MattermostTemplateSettings({
    autoAckMessage,
    caseCreatedMessage,
    afterHoursMessage,
    ...
    return (
        <Card>
            <CardHeader className="pb-3">
                ...
                <CardDescription className="text-xs">Customize automated message templates for Mattermost</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
                ...
                <div className="space-y-1.5">
                    ...
                    <p className="text-[10px] text-muted-foreground">
                        Variables: {'#{caseNumber}'}, {'#{driverName}'}, {'#{category}'}
                    </p>
                </div>
