      ...
      <CardContent className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              <Label htmlFor="loadUpdated">Load Updated</Label>
              <Switch
                id="loadUpdated"
                checked={preferences?.loadUpdated ?? true}
                onCheckedChange={(checked) => handleToggle('loadUpdated', checked)}
                disabled={updateMutation.isPending}
              />
            </div>
            <div className="flex items-center justify-between">
              ...
              <Switch
                id="maintenanceDue"
                checked={preferences?.maintenanceDue ?? true}
                onCheckedChange={(checked) => handleToggle('maintenanceDue', checked)}
                disabled={updateMutation.isPending}
              />
            </div>
            <div className="flex items-center justify-between">
              <Label htmlFor="hosViolation">HOS Violations</Label>
              <Switch
                id="hosViolation"
                checked={preferences?.hosViolation ?? true}
                onCheckedChange={(checked) => handleToggle('hosViolation', checked)}
                disabled={updateMutation.isPending}
              />
            </div>
            <div className="flex items-center justify-between">
              <Label htmlFor="documentExpiring">Document Expiring</Label>
              <Switch
                id="documentExpiring"
                checked={preferences?.documentExpiring ?? true}
                onCheckedChange={(checked) => handleToggle('documentExpiring', checked)}
                disabled={updateMutation.isPending}
              />
            </div>
            <div className="flex items-center justify-between">
              ...
              <Switch
                id="invoicePaid"
                checked={preferences?.invoicePaid ?? true}
                onCheckedChange={(checked) => handleToggle('invoicePaid', checked)}
                disabled={updateMutation.isPending}
              />
            </div>
            <div className="flex items-center justify-between">
              ...
              <Switch
                id="systemAlert"
                checked={preferences?.systemAlert ?? true}
                onCheckedChange={(checked) => handleToggle('systemAlert', checked)}
                disabled={updateMutation.isPending}
              />
            </div>
          </div>
