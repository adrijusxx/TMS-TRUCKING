...
const navItems: NavItem[] = [
  ...
  { name: 'Automation', href: '/dashboard/automation', icon: RefreshCw },
  ...
  { name: 'Tariffs & Payments', href: '/dashboard/settings/customizations/tariffs', icon: DollarSign },
  { name: 'Expenses', href: '/dashboard/settings/customizations/expenses', icon: FileText },
  { name: 'Order payment types', href: '/dashboard/settings/customizations/order-payment-types', icon: CreditCard },
  { name: 'Net Profit Calculation', href: '/dashboard/settings/customizations/net-profit', icon: Calculator },
  ...
  { name: 'Reports Customization', href: '/dashboard/settings/customizations/reports', icon: ChartBar },
  { name: 'Report constructor', href: '/dashboard/settings/customizations/report-constructor', icon: ChartBar },
  { name: 'Work order & Safety', href: '/dashboard/settings/customizations/work-order-safety', icon: Shield },
