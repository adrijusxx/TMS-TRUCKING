/**
 * IFTA Report By Driver API
 *
 * Generates quarterly IFTA reports grouped by driver with per-state breakdown.
 */
...
export async function GET(request: NextRequest) {
  try {
    ...
    const report = await iftaCalculatorService.generateQuarterlyReportByDriver(
    ...
    console.error('Error generating IFTA by-driver report:', error);
