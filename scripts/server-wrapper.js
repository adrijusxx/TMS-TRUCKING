...
// Node.js default keepAliveTimeout = 5s, ALB idle timeout = 60s (reduced to 30s in ALB config).
...
http.createServer = function (...args) {
  ...
  console.log('[Server] keepAliveTimeout=35s headersTimeout=36s applied');
  return server;
};
