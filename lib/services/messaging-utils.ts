 ...
 * Shared between Mattermost (and previously Telegram) integrations.
 */
...
/**
 * Check if message text contains any emergency keywords (case-insensitive).
 */
...
export function isWithinBusinessHours(
  ...
  try {
    ...
    console.warn(
      '[Messaging] Failed to check business hours, defaulting to within-hours',
    );
    return true;
  }
}
