...
const entityConfigs: Record<string, EntityConfig> = {
  ...
  loads: {
    ...
    fields: [
      ...
      { key: 'dispatcherId', label: 'Dispatcher ID', suggestedCsvHeaders: ['Dispatcher', 'dispatcher', 'Dispatch', 'Agent', 'created_by', 'Created By', 'Dispatcher Name', 'dispatcher_name', 'Dispatcher Email', 'dispatcher_email', 'Assigned Dispatcher', 'Dispatch Agent'] },
      ...
      { key: 'pickupState', label: 'Pickup State', suggestedCsvHeaders: ['Pickup State', 'pickup_state', 'Origin State', 'origin_state', 'PU State', 'PU ST', 'Orig State', 'Orig ST', 'Pickup ST', 'Ship From State'] },
      ...
      { key: 'deliveryState', label: 'Delivery State', suggestedCsvHeaders: ['Delivery State', 'delivery_state', 'Destination State', 'destination_state', 'Dest State', 'Dest ST', 'DEL State', 'DEL ST', 'Delivery ST', 'Ship To State'] },
