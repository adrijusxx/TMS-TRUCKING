...
export const PLAN_OPTIONS: PlanDetails[] = [
    {
        id: 'owner_operator',
        name: 'Free for Owner-Operators',
        description: 'Perfect for solo drivers and single-truck operations',
        features: [
            'All core dispatch features',
    ...
    },
    {
        ...
        description: 'Experience the full power of TMS Pro',
        features: [
        ...
        limitations: [
            ...
            'Downgrades to Core (read-only) after trial',
        ],
        recommended: true,
        badge: 'Full Access',
    },
